...
public class TaskActivity2 extends Fragment implements XListView.IXListViewListener, OnItemClickListener {
	...
	public static TaskActivity2 mm;
	private String LX = "";
...
//		 Toast.makeText(getApplicationContext(), LX, Toast.LENGTH_SHORT).show();
		spname = 	getActivity().getSharedPreferences("sdlxLogin",Context.MODE_PRIVATE + Context.MODE_PRIVATE).getString("spname", "");
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				json = WebServiceUtil.everycanforStr2("trueuname", "uname", "LX", "zt", "", "iPageNo",
						TrueName,  spname, LX, "1","", EmailPageNo, "GetDZGG");
