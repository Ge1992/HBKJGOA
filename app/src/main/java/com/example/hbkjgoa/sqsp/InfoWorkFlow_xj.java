...
public class InfoWorkFlow_xj extends Activity {
    private String sdcardDir = Environment.getExternalStorageDirectory().toString();
   // private NWork_XJ ap;
    public static InfoWorkFlow_xj mm;
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 1) {
                ...
                if (json2 != null && !json2.equals("") && json2.contains("|")) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(InfoWorkFlow_xj.this, AlertDialog.THEME_DEVICE_DEFAULT_LIGHT);
  ...
  //      ap = (NWork_XJ) intent.getSerializableExtra("NWork_XJ");
    ...
    private void findView() {
        ...
        zlcl01_T3.setVisibility(View.GONE);
    ...
    private void toshowhtml() {
        ...
        ziliaoWebView01.getSettings().setLayoutAlgorithm(WebSettings.LayoutAlgorithm.SINGLE_COLUMN);
        ziliaoWebView01.setWebChromeClient(new InfoWorkFlow_xj.MyWebChromeClient());
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == RESULT_OK) {
            ...
            if (requestCode == 0) {
                ...
                xh = data.getStringExtra("xh");
                wxmc=uname+"-"+xh+"-"+Sbname;
                ziliaoWebView01.loadUrl("javascript:setjydjname('" + wxmc + "','" + Sbid + "','" + "借用" + "')");
            }
        }
 ...
 //       bundle.putSerializable("NWorkToDo", ap);
        ...
        public boolean onJsAlert(WebView view, String url, String message, JsResult result) {
          ...
          /*  new AlertDialog.Builder(InfoWorkFlow_xj.this).
            ...
            if (message.contains("申购")){
             ...
             //   startActivityForResult(new Intent(InfoWorkFlow_xj.this, gdzc_list3.class),  1024);

                Intent intent = new Intent(InfoWorkFlow_xj.this, gdzc_list3.class);
                intent.putExtra("method", "GetSheBeiList");
                intent.putExtra("tile", "保修");
                startActivityForResult(intent, 1024);

            }else  if (message.contains("借用登记")){
              //  startActivityForResult(new Intent(InfoWorkFlow_xj.this, gdzc_list3.class), 1025);
                Intent intent = new Intent(InfoWorkFlow_xj.this, gdzc_list3.class);
                intent.putExtra("method", "GetJYSheBeiList");
                intent.putExtra("tile", "借用登记");
                startActivityForResult(intent, 1025);

            }else  if (message.contains("Date1008992615")){
                timePicker.show(time);
            }else {


                ziliaoWebView01.loadUrl("javascript:setwx('" + "申购" + "')");
    ...
    final class InJavaScriptLocalObj {
        ...
        public void showNR(String html) {
            Log.d("HTML1", html);
            sNR = html;
            Intent intent = new Intent(InfoWorkFlow_xj.this, Info_DoFlow_xj.class);
            putbundles();
...
*/
        ...
        timePicker = new CustomDatePicker(this, "请选择时间", new CustomDatePicker.ResultHandler() {
            ...
            public void handle(String time) {
                ...
                ziliaoWebView01.loadUrl("javascript:settime('" + time + "','" + "" + "')");
    ...
    private void initStatusBar() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            StatusBarUtils.setStatusBarColor(InfoWorkFlow_xj.this, R.color.btground);
        }
    }
