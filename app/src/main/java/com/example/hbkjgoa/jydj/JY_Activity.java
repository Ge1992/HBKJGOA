...
import com.example.hbkjgoa.adapter.SBJY_Adapter;
...
public class JY_Activity extends Fragment implements XListView.IXListViewListener, OnItemClickListener {
	private ListView listview;
	private SBJY_Adapter listViewAdapter;
	...
	private String spname,TrueName,json3,Department;
	 private String type = "";
	public static JY_Activity mm;
	private int newid;
	private Dialog progressDialog;
	public static JY_Activity listen;
	...
	private void setData(List<SBYJ_Bean> listitem) {
		listViewAdapter = new SBJY_Adapter(getActivity(), listitem);
		mListView.setAdapter(listViewAdapter);
	}
