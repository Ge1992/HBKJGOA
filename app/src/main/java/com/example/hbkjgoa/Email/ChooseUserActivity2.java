...
import com.example.hbkjgoa.adapter.UsersListViewAdapter_dx;
...
public class ChooseUserActivity2 extends Activity implements OnItemClickListener, XListView.IXListViewListener {
	private boolean webbing = false;
	private EditText editText1;
	private UsersListViewAdapter_dx listViewAdapter;
			...
			public void onClick(View v) {
				...
				if (listItemID.size() == 0) {
					AlertDialog.Builder builder1 = new AlertDialog.Builder(
							ChooseUserActivity2.this, AlertDialog.THEME_DEVICE_DEFAULT_LIGHT);
	...
	private void setData(List<Users> listitem) {
		listViewAdapter = new UsersListViewAdapter_dx(ChooseUserActivity2.this, listitem);
		mListView.setAdapter(listViewAdapter);
	}
	...
	private void getListItems() {
		boolean havenet = NetHelper.IsHaveInternet(ChooseUserActivity2.this);
		if (havenet) {
			LoadingDialog.Builder builder1=new LoadingDialog.Builder(ChooseUserActivity2.this)
					.setMessage("加载中...")
					.setCancelable(false);
			...
			ToastUtils.showToast(ChooseUserActivity2.this, "网络连接失败！");
		}
	}
	...
	private void initStatusBar() {
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
			...
			StatusBarUtils.setStatusBarColor(ChooseUserActivity2.this, R.color.btground);
		}
	}
}
