...
public class MyGridAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(url.contains(".mp4")){
			...
			viewHolder.imageView.setImageBitmap(PicUtils.createBitmap(getVideoThumbnail(url,250,250, Images.Thumbnails.MICRO_KIND), photo));
		//	viewHolder.imageView.setImageBitmap(PicUtils.createBitmap(createVideoThumbnail(url, 250,250), photo));
		}else{
