...
import com.example.hbkjgoa.adapter.XMLXAdapter_BM;
 ...
 * 第一个页面
 */
public class BM extends Fragment implements AdapterView.OnItemClickListener, XListView.IXListViewListener {
    private String wz;
    private String str;
    ...
    private XMLXAdapter_BM adapter;
    private int fid = 0;
    private int step = 1;
    ...
    private void setData(List<TXL_New> listitem) {
        adapter = new XMLXAdapter_BM(getActivity(), listitem);
