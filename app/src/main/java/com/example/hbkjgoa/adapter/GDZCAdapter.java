...
public class GDZCAdapter extends BaseAdapter {
	...
	public GDZCAdapter(Context context, List<GDZC_Bean> listItems) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
	    ...
	    listItemView.text03.setText(Html.fromHtml("品牌: <font color='#3592D1'>"+listItems.get(position).getShengChanChangJia()+"</font> "));
...
/*		convertView.setOnClickListener(new View.OnClickListener() {
			@Override+"     人员："+listItems.get(position).getGuanLiUser()
			public void onClick(View arg0) {
				new SJ_Bean();
				GDZC_Bean localGZRZ = listItems.get(w);
				Intent intent = new Intent();
				intent.setClass(context, InfoGDZC.class);
