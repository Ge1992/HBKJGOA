...
public class XMJL_SJXAdapter_sjx extends BaseAdapter {
	...
	public XMJL_SJXAdapter_sjx(Context context, List<Xmjl_sjxBean> listItems) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (listItems.get(position).getEmailState().equals("已读")){
			listItemView.zt.setTextColor(Color.rgb(0, 0, 0));
		}else {
			listItemView.zt.setTextColor(Color.rgb(213, 0, 5));
		}
		if (listItems.get(position).getEmailState().equals("已读")) {
