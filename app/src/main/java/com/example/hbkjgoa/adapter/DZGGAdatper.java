...
import com.example.hbkjgoa.sjyw.YWFB3;
...
public class DZGGAdatper extends BaseAdapter {
	...
	public DZGGAdatper(Context context, List<DZGG> listItems) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		convertView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				intent.setClass(context, YWFB3.class);
